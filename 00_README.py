...
# MAGIC 
# MAGIC <img src="./resource/images/ClaimsProcess.png" width="70%" height="70%">
...
# MAGIC <img src="./resource/images/smart_claims_process.png" width="70%" height="70%">
# MAGIC 
...
# MAGIC <img src="./resource/images/datasets.png" width="60%" height="60%">
# MAGIC 
...
# MAGIC 
# MAGIC # Domain Model
# MAGIC <img src="./resource/images/domain_model.png">
# MAGIC 
...
# MAGIC <img src="./resource/images/rule_engine.png" width="70%" height="70%">
# MAGIC 
# MAGIC # Workflow
...
# MAGIC <img src="./resource/images/workflow.png" width="60%" height="60%">
...
# MAGIC 
# MAGIC <img src="./resource/images/medallion_architecture_dlt.png" width="80%" height="80%">
# MAGIC                                                                                    
...
# MAGIC <img src="./resource/images/summary_dashboard.png" width="60%" height="60%">
# MAGIC 
...
# MAGIC <img src="./resource/images/ClaimsInvestigation.png" width="80%" height="80%">
# MAGIC 
